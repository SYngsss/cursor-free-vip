...
def get_cursor_paths(translator=None) -> Tuple[str, str]:
    ...
    default_paths = {
        ...
        "Linux": ["/opt/Cursor/resources/app", "/usr/share/cursor/resources/app", "/home/yupan/下载/squashfs-root/usr/share/cursor/resources/app", os.path.expanduser("~/.local/share/cursor/resources/app"), "/usr/lib/cursor/app/"]
    }
...
def get_workbench_cursor_path(translator=None) -> str:
    ...
    paths_map = {
        ...
        "Linux": {
            "bases": ["/opt/Cursor/resources/app", "/home/yupan/下载/squashfs-root/usr/share/cursor/resources/app", "/usr/share/cursor/resources/app", "/usr/lib/cursor/app/"],
            "main": "out/vs/workbench/workbench.desktop.main.js"
        }
    }
